		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-sm-12 col-xs-12">
					...
					<div class="owl-carousel owl-theme slide" id="featured">
						<div class="item">
							<article class="featured">
								...
								<figure>
									<img src="${ctp}/resources/images/basic/img04.jpg" alt="Sample Article">
								</figure>
								<div class="details">
						...
						<div class="item">
							<article class="featured">
								<div class="overlay"></div>
								<figure>
									<img src="${ctp}/resources/images/basic/img14.jpg" alt="Sample Article">
								</figure>
								<div class="details">
						...
						<div class="item">
							<article class="featured">
								<div class="overlay"></div>
								<figure>
									<img src="${ctp}/resources/images/basic/img13.jpg" alt="Sample Article">
								</figure>
								<div class="details">
						...
						<div class="item">
							<article class="featured">
								<div class="overlay"></div>
								<figure>
									<img src="${ctp}/resources/images/basic/img05.jpg" alt="Sample Article">
								</figure>
								<div class="details">
							...
							<div class="row">
								<article class="article col-md-12">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="${ctp}/resources/images/basic/img10.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
											<div class="detail">
								...
								<article class="article col-md-12">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="${ctp}/resources/images/basic/img06.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
											<div class="detail">
							...
							<div class="row">
								...
								<article class="article col-md-12">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="${ctp}/resources/images/basic/img07.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
											<div class="detail">
					...
					<div class="banner">
						<a href="#">
							<img src="${ctp}/resources/images/basic/ads.png" alt="Sample Article">
						</a>
					</div>
							...
							<div class="body-col vertical-slider" data-max="4" data-nav="#hot-news-nav" data-item="article">
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="${ctp}/resources/images/basic/img09.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
								...
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="${ctp}/resources/images/basic/img01.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
											<h1><a href="single.html">Duis aute irure dolor in reprehenderit in voluptate velit</a></h1>
								...
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="${ctp}/resources/images/basic/img02.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
								...
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="${ctp}/resources/images/basic/img08.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
					...
					<div class="row">
						<article class="col-md-12 article-list">
							<div class="inner">
								<figure>
									<a href="single.html">
										<img src="${ctp}/resources/images/basic/img11.jpg" alt="Sample Article">
									</a>
								</figure>
								<div class="details">
									<div class="detail">
						...
						<article class="col-md-12 article-list">
							<div class="inner">
								<figure>
									<a href="single.html">
										<img src="${ctp}/resources/images/basic/img03.jpg" alt="Sample Article">
									</a>
								</figure>
								<div class="details">
									<div class="detail">
						...
						<div class="aside-body">
							<div class="featured-author">
								<div class="featured-author-inner">
									<div class="featured-author-cover" style="background-image: url('${ctp}/resources/images/basic/img15.jpg');">
										<div class="badges">
										...
										<div class="block">
											...
											<div class="block-body">
												<ul class="item-list-round" data-magnific="gallery">
													<li><a href="${ctp}/resources/images/basic/img06.jpg" style="background-image: url('${ctp}/resources/images/basic/img06.jpg');"></a></li>
													<li><a href="${ctp}/resources/images/basic/img07.jpg" style="background-image: url('${ctp}/resources/images/basic/img07.jpg');"></a></li>
													<li><a href="${ctp}/resources/images/basic/img08.jpg" style="background-image: url('${ctp}/resources/images/basic/img08.jpg');"></a></li>
													<li><a href="${ctp}/resources/images/basic/img09.jpg" style="background-image: url('${ctp}/resources/images/basic/img09.jpg');"></a></li>
													<li><a href="${ctp}/resources/images/basic/img10.jpg" style="background-image: url('${ctp}/resources/images/basic/img10.jpg');"></a></li>
													<li><a href="${ctp}/resources/images/basic/img11.jpg" style="background-image: url('${ctp}/resources/images/basic/img11.jpg');"></a></li>
													<li><a href="${ctp}/resources/images/basic/img12.jpg" style="background-image: url('${ctp}/resources/images/basic/img12.jpg');"><div class="more">+2</div></a></li>
													<li class="hidden"><a href="${ctp}/resources/images/basic/img13.jpg" style="background-image: url('${ctp}/resources/images/basic/img13.jpg');"></a></li>
													<li class="hidden"><a href="${ctp}/resources/images/basic/img14.jpg" style="background-image: url('${ctp}/resources/images/basic/img14.jpg');"></a></li>
												</ul>
											</div>
										</div>
							...
							<div class="tab-pane active" id="recomended">
								<article class="article-fw">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="${ctp}/resources/images/basic/img16.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="details">
											<div class="detail">
							...
							<div class="tab-pane comments" id="comments">
								<div class="comment-list sm">
									<div class="item">
										<div class="user">                                
											<figure>
												<img src="${ctp}/resources/images/basic/img01.jpg" alt="User Picture">
											</figure>
											<div class="details">
					...
					<aside id="sponsored">
						...
						<div class="aside-body">
							<ul class="sponsored">
								<li>
									<a href="#">
										<img src="${ctp}/resources/images/basic/sponsored.png" alt="Sponsored">
									</a>
								</li> 
								<li>
									<a href="#">
			...
			<div class="owl-carousel owl-theme carousel-1">
				...
				<article class="article">
					<div class="inner">
						<figure>
							<a href="single.html">
								<img src="${ctp}/resources/images/basic/img15.jpg" alt="Sample Article">
							</a>
						</figure>
						<div class="padding">
							<div class="detail">
